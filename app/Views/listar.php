                ...
                <div class="accordion-item">
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <th scope="col">Nombre y Apellido Tutor</th>
                            <th scope="col">DNI Tutor</th>
                            <th scope="col">Teléfono Tutor</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($datosI as $key):?>
                            <tr>
                                <td><?php echo $key->nombre?> <?php echo $key->apellido?></td>
                                <td><?php echo $key->dni?></td>
                                <td><?php echo $key->fnac?></td>
                                <td><?php echo $key->domicilio?></td>
                                <td><?php echo $key->nombre_tutor?> <?php echo $key->apellido_tutor?></td>
                                <td><?php echo $key->dni_tutor?></td>
                                <td><?php echo $key->tel_tutor?></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                        </table>
