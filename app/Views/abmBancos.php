  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <div class="row formulario-contacto">
            ...
            <div class="col-sm-12">
            <h1>Cargar Banco</h1>
                <form method="POST" action="<?php echo base_url().'/crearbanco' ?>">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" required>
                    <label for="sucursal">Sucursal</label>
                    <input type="number" name="sucursal" id="sucursal" class="form-control" pattern="[0-9]+"required>
        ...
        <h1>Listado de bancos:</h1>
                    ...
                    <?php foreach($datos as $key): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url().'/obtenerbanco/'.$key->nombre.'/'.$key->sucursal ?>" class="btn btn-warning btn-sm">Editar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/eliminarbanco/'.$key->nombre.'/'.$key->sucursal ?>" class="btn btn-danger btn-sm">Eliminar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/listarclientes/'.$key->nombre.'/'.$key->sucursal ?>" class="btn btn-success btn-sm">Clientes</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
