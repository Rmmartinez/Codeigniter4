                ...
                <div class="table table-responsive">
                    ...
                    <?php foreach($data as $key): ?>
                        <tr>
                            ...
                            <td><?php echo $key->cuit_cuil?></td>
                            <td><?php echo $key->dni?></td>
                            <td><?php echo $key->tel?></td>
                            <td>
                                <a href="<?php echo base_url().'/obtenercliente/'.$key->dni ?>" class="btn btn-warning btn-sm">Editar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/eliminarcliente/'.$key->dni ?>" class="btn btn-danger btn-sm">Eliminar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/cuentascliente/'.$key->dni ?>" class="btn btn-success btn-sm">Cuentas</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </table>
