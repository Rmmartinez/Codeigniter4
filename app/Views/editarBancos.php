  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <h1>Modificar Banco</h1>
            <div class="col-sm-12">
                <form method="POST" action="<?php echo base_url().'/actualizarbanco' ?>">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $nombre ?>"  readonly required>
                    <label for="sucursal">Sucursal</label>
                    <input type="text" name="sucursal" id="sucursal" class="form-control" value="<?php echo $sucursal ?>" readonly required>
